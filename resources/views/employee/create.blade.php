            ...
            <form action="{{route('store')}}" enctype="multipart/form-data" method="POST">
              ...
              <div class="overflow-hidden shadow sm:rounded-md">
                ...
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                  <button type="submit" class="inline-flex justify-center rounded-md border-2 border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700">ذخیره</button>
                </div>
              </div>
            </form>
    </div>
