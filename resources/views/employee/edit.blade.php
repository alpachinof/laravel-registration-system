...
<body dir="rtl">
  @include('alerts')
    <div class="mt-16">
            <form action="/employee/<?php echo $user[0]->id; ?>" enctype="multipart/form-data" method="POST">
              @csrf
                ...
                <div class="bg-white px-4 py-5 sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" name="firstname" value="{{$user[0]->firstname}}" class="h-10 mt-1 px-2 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-red-400 focus:ring-red-400 sm:text-sm">
                    </div>
      
                    <div class="col-span-6 sm:col-span-3">
                      <label for="lastname" class="block text-sm font-medium text-gray-700">نام خانوادگی</label>
                      <input type="text" name="lastname" value="{{$user[0]->lastname}}" class="h-10 mt-1 px-2 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>
      
                    <div class="col-span-6 sm:col-span-3">
                      <label for="birthplace" class="block text-sm font-medium text-gray-700">محل تولد</label>
                      <input type="text" name="birthplace" value="{{$user[0]->birthplace}}" class="h-10 mt-1 px-2 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>

                    <div class="col-span-6 sm:col-span-3">
                      <label for="birthplace" class="block text-sm font-medium text-gray-700">تاریخ تولد</label>
                      <input type="date" name="birthdate" value="{{$user[0]->birthdate}}" class="h-10 mt-1 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>
                    ...
                    <div class="col-span-6">
                      ...
                      <textarea type="text" name="address" rows="4" class="mt-1 block px-2 w-full resize-none rounded-md border-2 border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{$user[0]->address}}</textarea>
                    </div>
